...
import { dummyTransportMaster } from '@/data/TransportMaster';
...
export default function TransportMaster() {
  const { data, refresh, toggleStatus, deleteRecord } = useDummyCRUD(dummyTransportMaster);
  ...
  return (
    <MasterPageLayout
      ...
      description="Manage transport master records."
