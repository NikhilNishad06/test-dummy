...
import { dummyMineMaster } from '@/data/MineMaster';
...
export default function MineMaster() {
  const { data, refresh, toggleStatus, deleteRecord } = useDummyCRUD(dummyMineMaster);
  ...
  return (
    <MasterPageLayout
      title="Mine Master"
      description="Manage mine master records."
