...
import { dummyVehicleMaster } from '@/data/VehicleMaster';
...
export default function VehicleMaster() {
  const { data, refresh, toggleStatus, deleteRecord } = useDummyCRUD(dummyVehicleMaster);
  ...
  return (
    <MasterPageLayout
      ...
      description="Manage vehicle master records."
