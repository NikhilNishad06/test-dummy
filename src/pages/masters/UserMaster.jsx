...
import { dummyUserMaster } from '@/data/UserMaster';
...
export default function UserMaster() {
  const { data, refresh, toggleStatus, deleteRecord } = useDummyCRUD(dummyUserMaster);
  ...
  return (
    <MasterPageLayout
      title="User Master"
      description="Manage user master records."
