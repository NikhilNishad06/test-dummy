...
import { dummyBrokerMaster } from '@/data/BrokerMaster';
...
export default function BrokerMaster() {
  const { data, refresh, toggleStatus, deleteRecord } = useDummyCRUD(dummyBrokerMaster);
  ...
  return (
    <MasterPageLayout
      title="Broker / Commission Agent Master"
      description="Manage broker / commission agent master records."
