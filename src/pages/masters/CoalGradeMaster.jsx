...
import { dummyCoalGradeMaster } from '@/data/CoalGradeMaster';
...
export default function CoalGradeMaster() {
  const { data, refresh, toggleStatus, deleteRecord } = useDummyCRUD(dummyCoalGradeMaster);
  ...
  return (
    <MasterPageLayout
      ...
      description="Manage coal grade master records."
