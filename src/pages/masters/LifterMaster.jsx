...
import { dummyLifterMaster } from '@/data/LifterMaster';
...
export default function LifterMaster() {
  const { data, refresh, toggleStatus, deleteRecord } = useDummyCRUD(dummyLifterMaster);
  ...
  return (
    <MasterPageLayout
      title="Lifter Master"
      description="Manage lifter master records."
