...
const STAGES = [
  ...
  "Lifter Assigned", 
  "Work Order Created", 
  "Waiting For Truck Dispatch"
];

export default function DeliveryTimeline({ compact = false, currentStage = "Delivery Order", dealDate }) {
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6 max-w-3xl mx-auto">
      <div className="flex items-center space-x-4 mb-6">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Delivery Operations Timeline</h2>
          <p className="text-muted-foreground">Standardized workflow visualization prior to truck dispatch.</p>
        </div>
      </div>
      <Card>
        <CardHeader>
